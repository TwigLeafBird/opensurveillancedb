...
create schema if not exists "opensurveillancedb-alphav1";
  ...
  create table "opensurveillancedb-alphav1"."color" (
    "code" text not null,
    "name" text not null
      );
...
alter table "opensurveillancedb-alphav1"."color" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_color_option" (
...
alter table "opensurveillancedb-alphav1"."device_color_option" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_location" (
    "code" text not null,
    "name" text not null
      );
...
alter table "opensurveillancedb-alphav1"."device_location" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_manufacturer" (
...
alter table "opensurveillancedb-alphav1"."device_manufacturer" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_model" (
    "id" uuid not null default gen_random_uuid(),
    "name" text not null,
    "manufacturer" uuid,
    "shape_profile" uuid,
...
alter table "opensurveillancedb-alphav1"."device_model" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_possible_location" (
    "model_id" uuid not null,
...
alter table "opensurveillancedb-alphav1"."device_possible_location" enable row level security;
  ...
  create table "opensurveillancedb-alphav1"."device_shape_profile" (
    "id" uuid not null default gen_random_uuid(),
...
CREATE UNIQUE INDEX color_pkey ON "opensurveillancedb-alphav1".color USING btree (code);

CREATE UNIQUE INDEX device_color_option_pkey ON "opensurveillancedb-alphav1".device_color_option USING btree (model_id, color_id);

CREATE UNIQUE INDEX device_location_name_key ON "opensurveillancedb-alphav1".device_location USING btree (name);

CREATE UNIQUE INDEX device_location_pkey ON "opensurveillancedb-alphav1".device_location USING btree (code);

CREATE UNIQUE INDEX device_manufacturer_name_key ON "opensurveillancedb-alphav1".device_manufacturer USING btree (name);

CREATE UNIQUE INDEX device_manufacturer_pkey ON "opensurveillancedb-alphav1".device_manufacturer USING btree (id);

CREATE UNIQUE INDEX device_model_pkey ON "opensurveillancedb-alphav1".device_model USING btree (id);

CREATE UNIQUE INDEX device_possible_location_pkey ON "opensurveillancedb-alphav1".device_possible_location USING btree (model_id, location_code);

CREATE UNIQUE INDEX device_shape_profile_pkey ON "opensurveillancedb-alphav1".device_shape_profile USING btree (id);
